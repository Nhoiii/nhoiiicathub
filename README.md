...
if PlayerGui:FindFirstChild("RedzLoadingUI") then
    PlayerGui.RedzLoadingUI:Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "RedzLoadingUI"
...
Logo.Position = UDim2.new(0.5, -35, 0, -45)
Logo.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
Logo.Image = "rbxassetid://114578517500917" 
...
LoadingBG.BackgroundColor3 = Color3.fromRGB(35, 35, 35)
...
StatusText.Text = "Starting Protocol..."
...
local function RunLoading()
    ...
    task.spawn(function()
        local texts = {"loading...", "loading..", "loading.", "Success!"}
        for i = 1, #texts do
            StatusText.Text = texts[i]
            task.wait(Duration / #texts)
        end
    end)
    ...
    tween.Completed:Connect(function()
        ...
        MainFrame:TweenPosition(UDim2.new(0.5, -200, 1.2, 0), "In", "Back", 0.5)
        task.wait(0.6)
        ScreenGui:Destroy()
...
game:GetService("StarterGui"):SetCore("SendNotification", {
    Title = "Nhoiii Cat Hub",
    Text = "Welcome to Nhoiii Cat Hub scripts!",
    Icon = "rbxassetid://114578517500917", 
    Duration = 5 
})

local screenGui = Instance.new("ScreenGui")
screenGui.Name = "ControlGUI"
-- ... (Các phần code còn lại của bạn)
...
local Window = Fluent:CreateWindow({
    Title = "Redz Roblox Hub",
    SubTitle = " by Redz Roblox",
    TitleIcon = "rbxassetid://121687807576347", 
    Image = "rbxassetid://121687807576347", 
...
-- [[ SHΔDØW CORE: REDZ BUTTON PROTOCOL ]]

local screenGui = Instance.new("ScreenGui")
screenGui.Name = "ControlGUI"
screenGui.ResetOnSpawn = false
-- Sử dụng PlayerGui để tránh lỗi phân quyền trên một số thiết bị
screenGui.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")

local toggleButton = Instance.new("ImageButton")
toggleButton.Name = "RedzToggleButton"
toggleButton.Size = UDim2.new(0, 50, 0, 50)
toggleButton.Position = UDim2.new(0.15, 0, 0.15, 0)
toggleButton.Image = "rbxassetid://114578517500917"
toggleButton.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- Nền đen cho sang trọng
toggleButton.BackgroundTransparency = 0.3 -- Độ trong suốt nhẹ
toggleButton.Parent = screenGui

local corner = Instance.new("UICorner")
corner.CornerRadius = UDim.new(0.3, 0) -- Bo góc mượt hơn
corner.Parent = toggleButton

-- [[ THIẾT LẬP VIỀN MÀU ĐỎ ]]
local stroke = Instance.new("UIStroke")
stroke.Thickness = 2.5
stroke.Color = Color3.fromRGB(255, 0, 0) -- ĐỎ RỰC (RED)
...
-- Logic Kéo Thả (Draggable) mượt mà
...
toggleButton.MouseButton1Click:Connect(function()
    ...
    -- Chèn logic gọi Menu của bạn vào đây
    if Window then 
        Window:Minimize(not isFluentVisible)
    else
        print("Shadow Core: Window not found. Toggle state:", isFluentVisible)
    end
end)
local Tabs = {
  Main = Window:AddTab({Title = "Tab Farming", Icon = "home"}),
  Settings = Window:AddTab({Title = "Tab Setting Farm", Icon = "settings"}),
  Melee = Window:AddTab({Title = "Tab Auto Get Melee V2", Icon = "box"}),
  Quests = Window:AddTab({Title = "Tab Items Farm", Icon = "swords"}),
  SeaEvent = Window:AddTab({Title = "Tab Sea Events", Icon = "waves"}),
  Mirage = Window:AddTab({Title = "Tab Mirage + RaceV4", Icon = "crown"}),
  Drago = Window:AddTab({Title = "Tab Drago Dojo", Icon = "shield"}),
  Prehistoric = Window:AddTab({Title = "Tab Prehistoric", Icon = "flame"}),
  Raids = Window:AddTab({Title = "Tab Raid", Icon = "cherry"}),
  Combat = Window:AddTab({Title = "Tab Combat PVP", Icon = "user"}),
  Travel = Window:AddTab({Title = "Tab Teleport", Icon = "locate"}),
  Fruit = Window:AddTab({Title = "Tab Fruits", Icon = "apple"}),
  Shop = Window:AddTab({Title = "Tab Shop", Icon = "shopping-cart"}),
  Misc = Window:AddTab({Title = "Tab Misc", Icon = "layout-grid"})
}

Tabs.Main:AddButton({
        Title="Link Join Sever Discord",
        Description=" https://discord.gg/8HDXpyRE",
        Callback=function()
            setclipboard(tostring(" https://discord.gg/8HDXpyRE")) 
        end
})
Tabs.Main:AddSection("Farm level")
local FarmLevel = Tabs.Main:AddToggle("FarmLevel", {Title = "Auto Farm Level", Description = "Farm lên Level 2750", Default = false})
